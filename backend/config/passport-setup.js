...
passport.use(
    new GoogleStrategy({
        ...
        callbackURL:'http://localhost:5000/api/user/google/redirect',  //Root url already mentioned in google developers console, for deployemnt , we need to give full callback address ,relative one wont work
