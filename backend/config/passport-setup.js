...
passport.use(
    new GoogleStrategy({
        ...
        callbackURL:'https://convohub-l7f3.onrender.com/api/user/google/redirect',  //Root url already mentioned in google developers console, for deployemnt , we need to give full callback address ,relative one wont work
        ...
        try {
             ...
             // Extract the google pic (jin logo ka pic nhi hota hai,unn logo ke liye bhi google initial wala pic rakhta hai, so, initial name pic would be used )
            ...
            if (existingUser) {
                ...
                existingUser.pic=profilePic;  //override the pic(existing pic will be overriden with google profile pic)
