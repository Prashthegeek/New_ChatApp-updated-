...
const deleteMessage = async(req,res) =>{
  ...
  message.content="";//clear the text content
  message.file="";//clear the file reference.
  //both the file ,and content were the fields /key of the each message in the schema along with the isDeleted
  await message.save();
