...
//come here afer pages/chatPage.js
const Chatbox = ({ fetchAgain, setFetchAgain }) => {
  const { selectedChat } = ChatState();  //This line uses the ChatState hook to extract the selectedChat variable(which is an object of the selected chat,can see mychats.js where it was filled up with values) from the chat context. selectedChat would represent the currently active or selected chat.
